                ...
                <div className="space-y-8">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <p className="text-lg text-muted-foreground">
                        Click the microphone below to begin talking with our AI assistant
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="mx-auto max-w-md space-y-2">
                    ...
                    <p className="text-xs text-muted-foreground">
                      Our AI will understand your question and provide instant assistance
                    </p>
                  </div>
                ...
                {[
                  {
                    step: "1",
                    title: "Click & Speak",
                    description: "Press the microphone button above and describe your issue",
                    color: "bg-blue-500"
                  },
                  {
                    step: "2", 
                    title: "AI Listens",
                    description: "Our assistant processes your question in real-time",
                    color: "bg-green-500"
                  },
                  {
                    step: "3",
                  ...
                  <div key={index} className="flex gap-3 rounded-lg border p-3 transition-colors hover:bg-muted/50">
                    <div className={`flex h-6 w-6 shrink-0 items-center justify-center rounded-full ${item.color} text-white text-xs font-semibold`}>
                      {item.step}
                    </div>
            ...
            <CardContent>
              <div className="space-y-2">
                {[
                  ...
                  <div key={index} className="group flex items-center gap-3 rounded-lg border p-2 transition-all hover:border-primary/50 hover:bg-muted/50">
                    <div className={`flex h-8 w-8 shrink-0 items-center justify-center rounded-lg ${feature.bgColor}`}>
          ...
          {[
            ...
            <Card key={index} className="border-0 bg-muted/30 text-center">
              <CardContent className="p-4">
                ...
                <h3 className="mb-1 font-semibold text-sm">{highlight.title}</h3>
